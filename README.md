...
Implementation of quantum query algorithms and their use in symmetric cryptanalysis. Its main focus is Simon’s algorithm, together with small, reproducible simulations of Simon-style attacks on toy cryptographic constructions.
